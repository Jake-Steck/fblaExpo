...
export default function SignInHeader() {
    ...
    return (
        <>
            ...
            <Text style={{ fontFamily: 'OpenSans_700Bold', position: 'absolute', textAlign: 'center', alignSelf: 'center', marginTop: '90%', fontSize: '29rem', color: '#3D3D3D' }}>Forgot Password</Text>
