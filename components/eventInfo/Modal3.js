    ...
    return (
        <View style={{ backgroundColor: 'white', height: '100%', width: '100%' }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, paddingLeft: 40, paddingRight: 40 }}>
                <View>
                    <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Location: Montclair High School</Text>
                    <Text style={{ fontSize: 15, color: 'grey' }}>Sport: Basketball</Text>
                    <Text style={{ fontSize: 15, color: 'grey' }}>Against: Montclair High School</Text>
                    <Text style={{ fontSize: 15, color: 'grey' }}>Date: March 23, 2023</Text>
                    <Text style={{ fontSize: 15, color: 'grey' }}>Time: 4:30 PM</Text>
                </View>
            </View>
